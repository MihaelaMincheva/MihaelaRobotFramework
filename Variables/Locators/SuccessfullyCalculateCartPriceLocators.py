...
cart_page_unit_subtotal = "xpath=//td[@class='cart_unit']"
unit_price_per_each = "xpath=//td[@class='cart_unit']"
unit_price_without_dollar = "xpath=//td[@class='cart_unit']"
total_price = "xpath=//span[@id='total_product_price_3_14_0']"
unit_total_price = "xpath=//td[@class='cart_unit']"
